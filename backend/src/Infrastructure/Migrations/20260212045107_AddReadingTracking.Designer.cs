...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260212045107_AddReadingTracking")]
    partial class AddReadingTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.SeoCrawlJob", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_seo_crawl_jobs");

                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_seo_crawl_jobs_created_at");

                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_seo_crawl_jobs_site_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_seo_crawl_jobs_status");

                    b.ToTable("seo_crawl_jobs", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.SeoCrawlResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("XRobotsTag")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("x_robots_tag");

                    b.HasKey("Id")
                        .HasName("pk_seo_crawl_results");
            ...
            modelBuilder.Entity("Domain.Entities.SeoCrawlJob", b =>
                {
                    b.HasOne("Domain.Entities.Site", "Site")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_seo_crawl_jobs_sites_site_id");
            ...
            modelBuilder.Entity("Domain.Entities.SeoCrawlResult", b =>
                {
                    b.HasOne("Domain.Entities.SeoCrawlJob", "Job")
                        .WithMany("Results")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_seo_crawl_results_seo_crawl_jobs_job_id");
